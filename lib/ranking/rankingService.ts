...
const SKILL_DICTIONARY = [
  'react', 'nextjs', 'nodejs', 'mongodb', 'express', 'typescript', 'docker', 'aws',
  'python', 'javascript', 'java', 'c++', 'c#', 'ruby', 'php', 'go', 'golang', 'rust',
  'swift', 'kotlin', 'scala', 'perl', 'r', 'matlab', 'sql', 'mysql', 'postgresql',
  'postgres', 'sqlite', 'oracle', 'mariadb', 'redis', 'elasticsearch', 'graphql',
  'rest api', 'restful', 'api', 'git', 'github', 'gitlab', 'bitbucket', 'ci/cd',
  'jenkins', 'kubernetes', 'k8s', 'terraform', 'ansible', 'puppet', 'chef',
  'linux', 'unix', 'bash', 'powershell', 'azure', 'gcp', 'google cloud',
  'firebase', 'heroku', 'netlify', 'vercel', 'tailwind', 'bootstrap', 'sass',
  'html', 'css', 'jquery', 'angular', 'vue', 'vuejs', 'svelte', 'redux',
  'webpack', 'babel', 'eslint', 'jest', 'mocha', 'chai', 'cypress', 'playwright',
  'pytest', 'selenium', 'django', 'flask', 'fastapi', 'spring', 'spring boot',
  'hibernate', 'jpa', 'asp.net', '.net', 'laravel', 'symfony', 'rails',
  'tensorflow', 'pytorch', 'keras', 'scikit-learn', 'pandas', 'numpy',
  'machine learning', 'deep learning', 'artificial intelligence', 'ai',
  'data science', 'data analytics', 'data analysis', 'data engineering',
  'data visualization', 'natural language processing', 'nlp', 'computer vision',
  'tableau', 'power bi', 'powerbi', 'looker', 'excel', 'google sheets',
  'spark', 'apache spark', 'hadoop', 'kafka', 'airflow', 'snowflake',
  'big data', 'etl', 'statistics', 'statistical analysis', 'regression',
  'classification', 'clustering', 'time series', 'forecasting', 'a/b testing',
  'web scraping', 'crm', 'erp', 'saas', 'agile', 'scrum', 'jira', 'confluence',
  'figma', 'sketch', 'adobe xd', 'photoshop', 'illustrator', 'ui/ux', 'ui design',
  'ux design', 'product management', 'project management', 'business analysis',
  'requirements gathering', 'stakeholder management', 'technical writing',
  'digital marketing', 'seo', 'sem', 'content marketing', 'social media',
  'communication', 'leadership', 'team management', 'problem solving',
  'critical thinking', 'analytical skills', 'research', 'presentation',
];
